...
public class Slatch {
    ...
    private void loadTutoriel()
    {
        try {
            Image image;
                ...
                image = ImageIO.read(getClass().getClassLoader().getResource("Images/tutoriel/tableauunite1.png"));
                aImages.put("tableauunite1",image);
                
                image = ImageIO.read(getClass().getClassLoader().getResource("Images/tutoriel/tableauunite2.png"));
                aImages.put("tableauunite2",image);
        }
        catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void loadImageMap()
    {
        try {
                ...
                image = ImageIO.read(getClass().getClassLoader().getResource("Images/menu/yingyang.png"));
                aImages.put("yingyang",image);
    ...
    private void loadAutre()
    {
        try {
                ...
                image = ImageIO.read(getClass().getClassLoader().getResource("Images/campagne/generalrobot.png"));
                aImages.put("GeneralRobot",image);
