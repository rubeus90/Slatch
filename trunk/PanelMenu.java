    ...
    public void paintComponent (final Graphics g) 
    {
        ...
        else if(aMenuRapide)
        {
            ...
            else if(aSousMenuRapide2)
            {
                ...
                g.drawString("�quipe",this.getWidth()/20,this.getHeight()/2-aHauteurBouton);
                ...
                if(Slatch.ihm.getValBrouillard() == true){aStrBrouillard ="Activ�";}
                else{aStrBrouillard ="D�sactiv�";}
                g.drawString(""+aStrBrouillard,(3)*this.getWidth()/10,this.getHeight()/2+2*aHauteurBouton);
                if(Slatch.ihm.getValAnimation() == true){aStrAnimation ="Activ�";}
                else{aStrAnimation ="D�sactiv�";}
        ...
        else if(aMenuParametres)
        {
            ...
            g.setFont(fontVisitorbis);
            g.drawString("�ela ne d�sactive pas le brouillard du mode campagne",this.getWidth()/2-fmVisitorbis.stringWidth("�ela ne d�sactive pas le brouillard du mode campagne")/2,10*this.getHeight()/21);
        }
...
//                Slatch.campagne.createDialogue();
        ...
        {  
            ...
            else if(aSousMenuRapide2)
            {
                ...
                for(int i =0;i<4;i++)
                {
                    ...
                    if(pY>this.getHeight()/2+aHauteurBouton-hR && pY<this.getHeight()/2+aHauteurBouton && pX>(2+2*i)*this.getWidth()/10 && pX<(2+2*i)*this.getWidth()/10+SizeNiveauIA)
                    {
                           switch(aNiveauIA[i])
                           {
                               case("D�sactiv�") : aNiveauIA[i]="Moyen";aIA[i+1] = true;break;
                               case("Moyen") : aNiveauIA[i]="L�gendaire";aIA[i+1] = true;break;
                               case("Legendaire") : aNiveauIA[i]="D�sactiv�";aIA[i+1] = false;break;
                           }
                           this.repaint();
                    }
                ...
                {
                   if(aStrBrouillard.equals("Activ�")){aStrBrouillard="D�sactive";Slatch.ihm.setValBrouillard(false);}
                   else{aStrBrouillard="Activ�"; Slatch.ihm.setValBrouillard(true);}
                   this.repaint();
                }
                ...
                {
                   if(aStrAnimation.equals("Activ�")){aStrAnimation="Desactiv�";Slatch.ihm.setValAnimation(false);}
                   else{aStrAnimation="Activ�"; Slatch.ihm.setValAnimation(true);}
                   this.repaint();
                }
            ...
            else if(aMenuParametres)
            {
                ...
                {
                   if(aStrBrouillard.equals("Activ�")){aStrBrouillard="Desactiv�";Slatch.ihm.setValBrouillard(false);}
                   else{aStrBrouillard="Activ�"; Slatch.ihm.setValBrouillard(true);}
                   this.repaint();
                }
                ...
                {
                   if(aStrAnimation.equals("Activ�")){aStrAnimation="D�sactiv�";Slatch.ihm.setValAnimation(false);}
                   else{aStrAnimation="Activ�"; Slatch.ihm.setValAnimation(true);}
                   this.repaint();
                }
