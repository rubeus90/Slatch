 ...
 public class CreationMaps extends JPanel implements ActionListener, MouseListener {
    ...
    private String aJoueur;
 	...
 	public CreationMaps(){
        ...
        MATRICE_TEST = partieNew.getTerrain();
 		...
 		panelSelection.setBorder(BorderFactory.createTitledBorder("Les terrains disponibles:"));
		...
		panelSelection.add(panelJoueurs, BorderLayout.SOUTH);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource() == panelMap){
			...
			panelMap.getPartie().getTerrain()[pX][pY] = new Terrain(pX, pY, Integer.parseInt(aJoueur), TypeTerrain.valueOf(aID));
			panelMap.repaint();
